<template>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <h3 class="text-center text-dark mt-2">
          Laravel 11 Vue JS Vite CRUD ( Create Read Update and Delete)
        </h3>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        <h2 class="text text-center">Student List</h2>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">ID</th>
          ...
          <tbody>
            <tr v-for="student in result" v-bind:key="student.id">
              ...
              <td>{{ student.phone }}</td>
              <td>
                <button type="button" class="btn btn-primary" @click="edit(student)">
                  Edit
                </button>
...
export default {
  ...
  methods: {
    ...
    logout() {
          localStorage.removeItem('islogged', 'true'); 
